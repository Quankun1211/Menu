    ...
    <View style={OrderStyles.card}>
      <View style={OrderStyles.contentRow}>
        <View style={OrderStyles.infoCol}>
          ...
          <Text style={OrderStyles.orderCode}>Đơn hàng #XYZ</Text>
          ...
          <View style={OrderStyles.buttonGroup}>
            ...
            {order.status === 'delivered' && (
              <View style={{ flexDirection: 'row' }}>
                <TouchableOpacity style={OrderStyles.secondaryBtn}>
                ...
                <TouchableOpacity style={OrderStyles.moreBtn}>
